...
<?php
	...
	//used to check if the user is exist or not !!
	if(isset($_POST["usernamecheck"])){ // this is a returned value from ajax js function
...
<html>
    <head>
        ...
        <script>
				function restrict(elem){
					...
					if(elem == "email"){
					rx = /[' "]/gi;
					// I don't want the user to use (' or spaces or " ) and it must be global(g) and case sensitive(i)
					} else if(elem == "username"){
					rx = /[^a-z0-9]/gi;// user name must be only a-z and 0-9
					}
				...
				function checkusername(){
					...
					if(u != ""){
						_("unamestatus").innerHTML = 'checking ...';// we can add an image tag here
    ...
    <div class="overall">
           	<div class="wrap_overall">
                ...
                <div id="pageMiddle">
                  <h3 class="signup">Sign Up Here</h3>
